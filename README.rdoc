...
=== TODO
* [X]More detail on breadcrumbs (and their suggested use as left nav filters)
...
* [X]Review the classes and create any additional classes that might be useful where only an instance variable currently exists
